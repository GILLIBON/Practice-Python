#!/usr/bin/python3
# 
#   Задание на перемещение персонажа показалось мне интересным, решил попробовать сделать что-то забавное.
#   Код получился не очень хорошим, но зато это честная работа!
#
...
while move != 'Стоп':
    ...
    if playerpos > 25 or playerpos < 0 or playerpos == 8 or playerpos == 17:
